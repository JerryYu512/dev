...
- [组件开发建议](组件开发建议/组件开发建议.md)
- [git提交规范](组件开发建议/git提交规范.md)
- [IOT教程](https://github.com/IoT-Technology/IoT-Technical-Guide)
- [HTTP接口设计指南](https://github.com/bolasblack/http-api-guide)
- [CPP设计模式](https://github.com/me115/design_patterns)
...
- [masterlab](https://www.masterlab.vip/help?md=install-windows-wamp)
...
- [fastsock](https://github.com/fastos/fastsocket)
...
- [结构体解析](https://github.com/trolldbois/ctypeslib)

### 3.2 python

#### 3.3.1 学习

- [小项目练习](https://github.com/Python-World/python-mini-projects)
...
- [electron示例](https://github.com/demopark/electron-api-demos-Zh_CN)

#### 3.4.2 AI

- [换脸DeepFaceLab](https://github.com/iperov/DeepFaceLab)
